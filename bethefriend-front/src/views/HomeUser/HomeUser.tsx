          ...
          <main className="header">
              <div className="header-content">
                ...
                <div className="header-left">
                  ...
                  <div className="buttons-home-user">
                  <button onClick={goToChat} className="buttonChat">Chat<img src={imagebutton2}className="button-icon2"/></button>
                <button onClick={goToProfiles} className="buttonPerfil">Perfis<img 
                src={imagebutton} className="roxo" /></button>
                  </div>
                </div>
           {/* RIGHT */}
